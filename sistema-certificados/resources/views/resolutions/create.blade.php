        ...
        <div class="card-body">
            ...
            <form action="{{ route('resolutions.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="area" class="form-control" id="area" placeholder="Nombre del Área" value="{{ old('area') }}" required>
                </div>
                <div class="form-group">
                ...
                <button type="submit" class="btn btn-primary">Guardar</button> <a href="{{ route('resolutions.index') }}" class="btn btn-secondary">Cancelar</a> </form>
        </div>
    </div>
@stop